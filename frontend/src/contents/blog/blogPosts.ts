...
export const blogPosts: BlogPostMeta[] = [
  ...
  {
    postId: "blog-005",
    slug: "saa-basic-architecture-patterns",
    title: "SAAで最初に押さえるAWS基本構成パターン",
    description:
      "Solutions Architect Associateで理解しておきたい静的サイト、サーバーレスAPI、3層Webアプリ、高可用性構成の基本を整理します。",
    category: "SAA",
    tags: ["SAA-C03", "構成図", "高可用性", "3層構成", "サーバーレス"],
    targetKeywords: [
      "SAA 構成図",
      "AWS アーキテクチャ 基本",
